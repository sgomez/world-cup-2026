/**
 * Prediction UI seam — reducer, action types, and locale display helpers.
 *
 * This file is intentionally NOT re-exported from modules/bracket/index.ts.
 * It is an internal seam for prediction UI components; server-side callers
 * (Bet aggregate, actions/bets, derive-result, Score module) must not depend
 * on it.
 */
